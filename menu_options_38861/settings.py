"""
Django settings for menu_options_38861 project.
...
ROOT_URLCONF = 'menu_options_38861.urls'
...
WSGI_APPLICATION = 'menu_options_38861.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "menu_options_38861 API",
    "DESCRIPTION": "API documentation for menu_options_38861 App",
    "VERSION": "v1",
}
